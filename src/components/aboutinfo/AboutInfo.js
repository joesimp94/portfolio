  ...
  return (
    <div>
      ...
      <p>
        ...
        school, only to throw it all away at university and trade languages for
        Chinese. Since graduating, I have spent my twenties living abroad,
        starting in China then migrating to South Korea. It was in these
        high-tech countries that I truly became enamoured with learning to code
        and software development, and after arriving back home earlier this year
        I began my full-stack development course to do just that.
      </p>
    </div>
  );
};
